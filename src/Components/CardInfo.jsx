         ...
         <div className='mt-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
            <div className='flex items-center justify-between border p-7 rounded-lg '>
                <div>
                    ...
                    <h2 className='font-bold text-2xl flex gap-2 items-center'><LiaRupeeSignSolid /> <div>{totalBudget}</div></h2>
                </div>
            ...
            <div className='flex items-center justify-between border p-7 rounded-lg '>
                <div>
                    ...
                    <h2 className='font-bold text-2xl flex gap-2 items-center'><LiaRupeeSignSolid /> <div>{totalSpent}</div></h2>
                </div>
