...
const Page = () => {
  ...
  return (
    <div className='p-4 sm:p-6 lg:p-8'>
      <h2 className='font-bold text-2xl sm:text-3xl'>Hi, {user?.email ? user?.email : "name"} ✌️</h2>
      <p className='text-gray-500 mt-2'>Here&#39;s what&#39;s happening with your money. Let&#39;s manage your expense</p>
